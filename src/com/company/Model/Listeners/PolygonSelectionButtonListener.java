 ...
 */
public class PolygonSelectionButtonListener implements ActionListener {

    private ImagePanel imagePanel;

    public PolygonSelectionButtonListener(ImagePanel imagePanel){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        imagePanel.factory.currentSelection = Selections.POLYGON;
    }
